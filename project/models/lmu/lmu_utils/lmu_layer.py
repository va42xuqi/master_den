# inspired by hrshtv but turned into pytorch lightning
import numpy as np
...
def leCunUniform(tensor):
    ...
    [3] Yann A LeCun, Léon Bottou, Genevieve B Orr, and Klaus-Robert Müller. Efficient backprop.
...
class LMUCell(L.LightningModule):
    """
    LMU Cell
...
class LMUFFT(L.LightningModule):
    """
